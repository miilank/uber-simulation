...
public class AdminRideHistoryDetailsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        TextView tvPassengerDriver = v.findViewById(R.id.tv_passenger_driver);
        ...
        if (ride != null) {
            ...
            tvPassengerDriver.setText("Driver");
    ...
    private void bindDetails(@NonNull View v, @NonNull RideDetailDto d) {
        ...
        if (d.driver != null) {
            ...
            String name = (safe(d.driver.getFirstName()) + " " + safe(d.driver.getLastName())).trim();
            if (name.isEmpty()) name = safe(d.driver.getEmail());
            tvName.setText(name);

            String contact = safe(d.driver.getEmail());
