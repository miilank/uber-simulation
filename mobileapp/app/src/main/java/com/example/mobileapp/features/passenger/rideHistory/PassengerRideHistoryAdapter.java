...
public class PassengerRideHistoryAdapter extends RecyclerView.Adapter<PassengerRideHistoryAdapter.RideViewHolder> {
    ...
    public PassengerRideHistoryAdapter(@NonNull List<Ride> rides, OnRideClickListener listener) {
        this.rides = rides;
